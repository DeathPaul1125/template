<x-app-layout>
    <x-slot name="header">Nuevo Rol</x-slot>

    <div class="max-w-xl mx-auto">
        <div class="mb-5">
            <h1 class="text-xl font-bold text-slate-800 dark:text-white">Crear Rol</h1>
            <p class="text-sm text-slate-500">Define un nombre y asigna los permisos correspondientes.</p>
        </div>
